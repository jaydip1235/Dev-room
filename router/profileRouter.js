...
router.post('/', authenticate , async(request , response) => {
    try {
        let {image,company , website , location , designation , skills , bio , githubUserName ,
            youtube , facebook , twitter , linkedin , instagram} = request.body;

        let profileObj = {};
        profileObj.user = request.user.id; // id gets from Token
        
        if(company) profileObj.company = company; else  profileObj.company=""
        ...
        if(designation) profileObj.designation = designation; else profileObj.designation=""
        if(skills) profileObj.skills = skills.toString().split(',').map(skill => skill.trim()); else profileObj.skills =""
        if(bio) profileObj.bio = bio; else profileObj.bio=""
        if(githubUserName) profileObj.githubUserName = githubUserName; else profileObj.githubUserName ="https://github.com/"

        // social Obj
        profileObj.social = {};
        if(youtube) profileObj.social.youtube = youtube; else profileObj.social.youtube="https://www.youtube.com/"
        if(facebook) profileObj.social.facebook = facebook; else profileObj.social.facebook="https://www.facebook.com/"
        if(twitter) profileObj.social.twitter = twitter; else profileObj.social.twitter="https://www.twitter.com/"
        if(linkedin) profileObj.social.linkedin = linkedin; else profileObj.social.linkedin="https://www.linkedin.com/"
        if(instagram) profileObj.social.instagram = instagram; else profileObj.social.instagram="https://www.instagram.com/"
